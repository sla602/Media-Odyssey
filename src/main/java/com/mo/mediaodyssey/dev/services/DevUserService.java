...
public class DevUserService {
     ...
     *
     * @param dto  The UserDto containing email and password for the new account.
    ...
    /**
     * Creates a developmental Admin account with the specified UserDto.
     *
     * @param dto The UserDto containing email and password for the new account.
     */
    @Transactional
    ...
    /**
     * Creates a developmental User account with the specified UserDto.
     *
     * @param dto The UserDto containing email and password for the new account.
     */
    @Transactional
    ...
    /**
     * Checks if development mode is enabled via environment variable.
     *
